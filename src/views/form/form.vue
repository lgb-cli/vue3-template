  ...
  <div class="page_content">
    ...
    <el-form :model="form" ref="formRef" label-width="150px">
      ...
      <el-form-item prop="" label="日期:">
        <el-date-picker v-model="form.time" type="date" label="Pick a date" placeholder="Pick a date" style="width: 100%" />
      </el-form-item>
      ...
      <el-form-item label="其他:">
        <el-input v-model="form.other" type="textarea" :rows="4" />
      </el-form-item>
...
const handleAvatarSuccess = (response: () => {}, uploadFile: any) => {
